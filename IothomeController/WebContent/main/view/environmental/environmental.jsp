...
pageEncoding="UTF-8" language="java" import="java.sql.*" import="java.util.*"%>
		...
		<p id="environmental-text" class="bg-success">원하는 온도를 설정할 수 있습니다.</p>
			...
			<table id="environmental-table" class="table table-hover">
				<tr>
					...
					<td class="right"><input type="text" id = "hightemp" name="hightemp" placeholder="현재 설정 : <%=dto1.getHighTemp() %>˚C"></td>
				</tr>
				<tr>
					<td class="left">설정할 최저온도: </td>
					<td class="right"><input type="text" id = "lowtemp" name="lowtemp" placeholder="현재 설정 : <%=dto1.getLowTemp() %>˚C"></td>
				</tr>
				<tr>
					<td class="left">설정할 최대습도: </td>
					<td class="right"><input type="text" id = "highhumi"name="highhumi" placeholder="현재 설정 : <%=dto1.getHighHumi()%>%"></td>
				</tr>
				<tr>
					<td class="left">설정할 최대습도: </td>
					<td class="right"><input type="text" id = "lowhumi"name="lowhumi" placeholder="현재 설정 : <%=dto1.getLowHumi()%>%"></td>
				</tr>
			</table>
