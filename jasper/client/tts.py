...
class naverTTS(AbstractTTSEngine):
    SLUG = "naver-tts"
#    @classmethod
#    def is_available(cls):
#        return (super(cls, cls).is_available() and
#                diagnose.check_executable('naver'))
    def say(self, phrase):
        client_id = "7ZsyLGzhXzjwr4v3glu2"
        client_secret = "j9bSJbPWdA"
        encText = urllib.quote(phrase)
